...
class Pipeline(object):
    ...
    def random_blur(self, probability, type_ = 'average', radius = 1):
        ...
        if not 0< probability <= 1:
            ...
            self.add_operation(Blur(probability,type_,radius))

    def random_sharpness(self,probability,min_factor=1,max_factor=1):
        """
